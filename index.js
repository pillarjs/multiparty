...
function Form(options) {
    ...
    self.useOriginalFielName = options.userOriginalFielName || false;
...
function uploadPath(baseDir, filename, useOriginalFilename) {
    var ext = path.extname(filename).replace(FILE_EXT_RE, '$1');
    var name = useOriginalFilename ? filename : randoString(18) + ext;
